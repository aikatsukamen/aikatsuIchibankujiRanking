...
const getRanking = async () => {
    try {
        ...
        logger_1.default.access.info(JSON.stringify(getOpt, null, '  '));
        ...
        logger_1.default.access.info(JSON.stringify(options, null, '  '));
        ...
        // 結果をアップロード
        logger_1.default.system.log(JSON.stringify(rankList, null, '  '));
        const resultOption = {
            method: 'POST',
            url: 'https://script.google.com/macros/s/AKfycbx_5LNDwQoA3r60vZzceNJMY49DxxHxfW3cnC9K1P8nYLpHaxeN/exec',
            json: true,
            body: {
                date: exports.converDateToStr(new Date()),
                rankList
            }
        };
        logger_1.default.access.info(JSON.stringify(resultOption, null, '  '));
...
getRanking();
new cron_1.CronJob('*/15 * * * *', getRanking).start();
/**
